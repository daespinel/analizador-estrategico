...
public class Motor {
    ...
    public static void fitness(Organizacion org1, Organizacion org2){
        ...
        if (org1.getSize()> org2.getSize()){
            ...
            org1.estrategia[0].setCerrarTienda(org1.estrategia[0].getPublicidad()+1);
            org1.estrategia[0].setCerrarTienda(org1.estrategia[0].getNoInvertir());
            ...
            org1.estrategia[1].setCerrarTienda(org1.estrategia[1].getPublicidad());
            org1.estrategia[1].setCerrarTienda(org1.estrategia[1].getNoInvertir()+2);
            ...
            org1.estrategia[2].setCerrarTienda(org1.estrategia[2].getPublicidad()+1);
            ...
            org2.estrategia[0].setCerrarTienda(org2.estrategia[0].getPublicidad()+1);
            org2.estrategia[0].setCerrarTienda(org2.estrategia[0].getNoInvertir());
            ...
            org2.estrategia[1].setCerrarTienda(org2.estrategia[1].getPublicidad());
            org2.estrategia[1].setCerrarTienda(org2.estrategia[1].getNoInvertir()+2);
            ...
            org2.estrategia[2].setCerrarTienda(org2.estrategia[2].getPublicidad()+1);
            org2.estrategia[2].setCerrarTienda(org2.estrategia[2].getNoInvertir()+1);
            ...
            org2.estrategia[3].setCerrarTienda(org2.estrategia[3].getPublicidad()+1);
            org2.estrategia[3].setCerrarTienda(org2.estrategia[3].getNoInvertir()+1);
            ...
            org1.estrategia[0].setCerrarTienda(org1.estrategia[0].getPublicidad());
            org1.estrategia[0].setCerrarTienda(org1.estrategia[0].getNoInvertir());
            ...
            org1.estrategia[1].setCerrarTienda(org1.estrategia[1].getPublicidad());
            org1.estrategia[1].setCerrarTienda(org1.estrategia[1].getNoInvertir());
            ...
            org1.estrategia[3].setAbrirTienda(org1.estrategia[3].getAbrirTienda()+2);
            org1.estrategia[3].setCerrarTienda(org1.estrategia[3].getCerrarTienda());
            org1.estrategia[3].setCerrarTienda(org1.estrategia[3].getPublicidad()+2);
            org1.estrategia[3].setCerrarTienda(org1.estrategia[3].getNoInvertir()+1);

            org2.estrategia[0].setAbrirTienda(org2.estrategia[0].getAbrirTienda()-1);
            org2.estrategia[0].setCerrarTienda(org2.estrategia[0].getCerrarTienda()+1);
            org2.estrategia[0].setCerrarTienda(org2.estrategia[0].getPublicidad());
            org2.estrategia[0].setCerrarTienda(org2.estrategia[0].getNoInvertir());
            ...
            org2.estrategia[1].setCerrarTienda(org2.estrategia[1].getPublicidad());
            org2.estrategia[1].setCerrarTienda(org2.estrategia[1].getNoInvertir());
            ...
            org2.estrategia[3].setAbrirTienda(org2.estrategia[3].getAbrirTienda()+2);
            org2.estrategia[3].setCerrarTienda(org2.estrategia[3].getCerrarTienda());
            org2.estrategia[3].setCerrarTienda(org2.estrategia[3].getPublicidad()+2);
            org2.estrategia[3].setCerrarTienda(org2.estrategia[3].getNoInvertir()+1);
        }
        if (org1.getGanancias()> org2.getGanancias()){
            ...
            org1.estrategia[0].setAbrirTienda(org1.estrategia[0].getAbrirTienda()+1);
            org1.estrategia[0].setCerrarTienda(org1.estrategia[0].getCerrarTienda());
            org1.estrategia[0].setCerrarTienda(org1.estrategia[0].getPublicidad()+2);
            org1.estrategia[0].setCerrarTienda(org1.estrategia[0].getNoInvertir()+1);
            org1.estrategia[1].setAbrirTienda(org1.estrategia[1].getAbrirTienda());
            org1.estrategia[1].setCerrarTienda(org1.estrategia[1].getCerrarTienda()+2);
            org1.estrategia[1].setCerrarTienda(org1.estrategia[1].getPublicidad()+1);
            org1.estrategia[1].setCerrarTienda(org1.estrategia[1].getNoInvertir()+2);
            org1.estrategia[2].setAbrirTienda(org1.estrategia[2].getAbrirTienda()-1);
            org1.estrategia[2].setCerrarTienda(org1.estrategia[2].getCerrarTienda()+1);
            org1.estrategia[2].setCerrarTienda(org1.estrategia[2].getPublicidad()+2);
            org1.estrategia[2].setCerrarTienda(org1.estrategia[2].getNoInvertir()+1);
            org1.estrategia[3].setAbrirTienda(org1.estrategia[3].getAbrirTienda()+2);
            org1.estrategia[3].setCerrarTienda(org1.estrategia[3].getCerrarTienda());
            org1.estrategia[3].setCerrarTienda(org1.estrategia[3].getPublicidad()+2);
            ...
            org2.estrategia[0].setAbrirTienda(org2.estrategia[0].getAbrirTienda()+1);
            org2.estrategia[0].setCerrarTienda(org2.estrategia[0].getCerrarTienda());
            org2.estrategia[0].setCerrarTienda(org2.estrategia[0].getPublicidad()+2);
            org2.estrategia[0].setCerrarTienda(org2.estrategia[0].getNoInvertir()+1);
            org2.estrategia[1].setAbrirTienda(org2.estrategia[1].getAbrirTienda());
            org2.estrategia[1].setCerrarTienda(org2.estrategia[1].getCerrarTienda()+2);
            org2.estrategia[1].setCerrarTienda(org2.estrategia[1].getPublicidad()+1);
            org2.estrategia[1].setCerrarTienda(org2.estrategia[1].getNoInvertir()+1);
            org2.estrategia[2].setAbrirTienda(org2.estrategia[2].getAbrirTienda()-1);
            org2.estrategia[2].setCerrarTienda(org2.estrategia[2].getCerrarTienda()+1);
            org2.estrategia[2].setCerrarTienda(org2.estrategia[2].getPublicidad()+2);
            org2.estrategia[2].setCerrarTienda(org2.estrategia[2].getNoInvertir()+1);
            org2.estrategia[3].setAbrirTienda(org2.estrategia[3].getAbrirTienda()+2);
            org2.estrategia[3].setCerrarTienda(org2.estrategia[3].getCerrarTienda());
            org2.estrategia[3].setCerrarTienda(org2.estrategia[3].getPublicidad()+2);
            ...
            org1.estrategia[2].setCerrarTienda(org1.estrategia[2].getCerrarTienda()+1);
            org1.estrategia[2].setCerrarTienda(org1.estrategia[2].getPublicidad()+1);
            org1.estrategia[2].setCerrarTienda(org1.estrategia[2].getNoInvertir());
            org1.estrategia[3].setAbrirTienda(org1.estrategia[3].getAbrirTienda()+2);
            org1.estrategia[3].setCerrarTienda(org1.estrategia[3].getCerrarTienda()+1);
            org1.estrategia[3].setCerrarTienda(org1.estrategia[3].getPublicidad()+1);
            org1.estrategia[3].setCerrarTienda(org1.estrategia[3].getNoInvertir());
            ...
            org2.estrategia[2].setCerrarTienda(org2.estrategia[2].getCerrarTienda()+1);
            org2.estrategia[2].setCerrarTienda(org2.estrategia[2].getPublicidad()+1);
            org2.estrategia[2].setCerrarTienda(org2.estrategia[2].getNoInvertir());
            org2.estrategia[3].setAbrirTienda(org2.estrategia[3].getAbrirTienda()+2);
            org2.estrategia[3].setCerrarTienda(org2.estrategia[3].getCerrarTienda()+1);
            org2.estrategia[3].setCerrarTienda(org2.estrategia[3].getPublicidad()+1);
            org2.estrategia[3].setCerrarTienda(org2.estrategia[3].getNoInvertir()); 
        }      
    }       
